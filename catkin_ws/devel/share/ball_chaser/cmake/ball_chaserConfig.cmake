...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/install)
...
if(NOT "/mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'yanglc <yanglc@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/devel/lib;/mnt/d/Udacity_robotics_nanodegree/project2/catkin_ws/devel/lib;/opt/ros/noetic/lib)
